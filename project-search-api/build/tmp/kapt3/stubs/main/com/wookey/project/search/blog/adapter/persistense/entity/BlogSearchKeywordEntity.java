...
@javax.persistence.Table(name = "blog_search_keyword", indexes = {@javax.persistence.Index(columnList = "keyword", unique = true, name = "idx_keyword"), @javax.persistence.Index(columnList = "search_count", name = "idx_search_count"), @javax.persistence.Index(columnList = "modified_at", name = "idx_modified_at")})
